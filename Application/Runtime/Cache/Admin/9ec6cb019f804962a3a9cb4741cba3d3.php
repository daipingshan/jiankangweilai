    ...
    <fieldset class="layui-elem-field w80">
        ...
        <div class="layui-field-box">
            <form class="layui-form layui-form-pane" action="">
                ...
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        <input type="hidden" name="knowledge_id" value="<?php echo I('get.knowledge_id');?>">
    ...
    <script>
        $(function () {
            ...
            form.on('submit(submit)', function (data) {
                var _this = this;
                _this.disabled = true;
                data.field.desc = UE.getEditor('desc');
                $.post("<?php echo U('saveQuestion');?>", data.field, function (res) {
                    if (res.status == 1) {
                        layer.msg(res.info, function () {
                            location.href = "<?php echo U('question',array('knowledge_id'=>I('get.knowledge_id')));?>"
                        });
                    } else {
