...
<div class="layui-layout layui-layout-admin">
    ...
    <a class="layui-btn layui-btn-danger" href="<?php echo U('addQuestion',array('knowledge_id'=>I('get.knowledge_id')));?>"><i
            class="layui-icon">
        &#xe654;</i>添加知识点问题
    </a>
...
<script>
    ...
    <script type="text/html" id="table-edit">
        <a class="layui-btn layui-btn-xs" href="<?php echo U('updateQuestion');?>?id={{d.id}}">编辑</a>
        <a class="layui-btn layui-btn-xs layui-btn-danger del-data"
           data-url="<?php echo U('delQuestion');?>?id={{d.id}}">删除</a>
    </script>
    <script>
        $(function () {
            var url = "<?php echo U('question',array('knowledge_id'=>I('get.knowledge_id')));?>";
            form.render();
