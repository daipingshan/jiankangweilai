...
<script>
    ...
    <script type="text/html" id="table-edit">
        {{# if(d.total_score == d.score){ }}
        <span style="color:#009688;">本次考试无错题记录</span>
        {{# } else { }}
        <a class="layui-btn layui-btn-xs">查看错题记录</a>
        {{# } }}
    </script>
    <script>
        $(function () {
            ...
            function getData(url) {
                table.render({
                    ...
                    , cols: [[
                        ...
                        , {field: 'total_question_num', title: '试题总数'}
                        , {field: 'total_score', title: '试卷总分'}
                        , {field: 'score', title: '实际得分'}
