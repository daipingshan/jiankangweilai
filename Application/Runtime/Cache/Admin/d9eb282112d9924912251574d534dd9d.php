...
<div class="layui-layout layui-layout-admin">
    ...
    <form class="layui-form search" action="" name="search">
        <div class="layui-row">
            ...
            <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
                <input type="text" name="question" value="<?php echo I('get.question');?>" placeholder="请输入试题问题"
                       class="layui-input">
            </div>
            <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
...
<script>
    ...
    <script type="text/html" id="table-edit">
        ...
        <a class="layui-btn layui-btn-xs layui-btn-danger del-data" data-url="<?php echo U('delete');?>?id={{d.id}}">删除</a>
    </script>
    ...
    <script>
        $(function () {
            ...
            function getKnowledge(test_paper_id) {
                $.get("<?php echo U('getKnowledgeData');?>", {test_paper_id: test_paper_id}, function (res) {
                    var data = res.info;
                    if (data.length > 0) {
