            ...
            <form class="layui-form layui-form-pane" action="">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <p style="margin-left:20px;line-height: 38px"><?php echo ($info['content']); ?></p>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <div id="pics-img">
                            <?php if(is_array($info["pics_data"])): $i = 0; $__LIST__ = $info["pics_data"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><div class="img-box">
    ...
    <script>
        $(function () {
            form.on('submit(submit)', function (data) {
                var _this = this;
                _this.disabled = true;
                $.post("<?php echo U('doReply');?>", data.field, function (res) {
                    if (res.status == 1) {
                        layer.msg(res.info, function () {
