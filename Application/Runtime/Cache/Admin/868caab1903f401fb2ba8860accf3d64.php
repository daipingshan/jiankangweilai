    ...
    <form class="layui-form search" action="" name="search">
        <div class="layui-row">
            <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
                <input type="text" name="course" value="<?php echo I('get.course');?>" placeholder="请输入课程名称" class="layui-input">
            </div>
            <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
                <select name="require">
                    <option value="">请选择课程类型</option>
                    <option value="1"
                    <?php if(I('get.require') == 1): ?>selected<?php endif; ?>
                    >必修</option>
                    <option value="2"
                    <?php if(I('get.require') == 2): ?>selected<?php endif; ?>
                    >选修</option>
                </select>
            </div>
            <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
...
<script>
    ...
    <script type="text/html" id="table-edit">
        ...
        <a class="layui-btn layui-btn-xs layui-btn-danger" href="<?php echo U('Knowledge/add');?>?course_id={{d.id}}">添加知识点</a>
        <a class="layui-btn layui-btn-xs layui-btn-warm" href="<?php echo U('Paper/add');?>?course_id={{d.id}}">添加试卷</a>
    </script>
    <script type="text/html" id="num">
        <a href="<?php echo U('Knowledge/index');?>?course_id={{d.id}}">【<span
