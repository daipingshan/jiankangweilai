...
<div class="layui-layout layui-layout-admin">
    ...
    <form class="layui-form search" action="" name="search">
        <div class="layui-row">
            ...
            <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
                <input type="text" name="real_name" value="<?php echo I('get.real_name');?>" placeholder="请输入真实姓名"
                       class="layui-input">
            </div>
            <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
                <select name="status">
...
<script>
    ...
    <script type="text/html" id="table-edit">
        ...
        <a class="layui-btn layui-btn-xs layui-btn-danger"
           href="<?php echo U('CaregiverBaby/add');?>?trainer_id={{d.id}}">添加养育人-宝宝</a>
        {{# } }}
        <a class="layui-btn layui-btn-xs layui-btn-warm"
           href="<?php echo U('Train/index');?>?trainer_id={{d.id}}">入户记录</a>
        <a class="layui-btn layui-btn-xs layui-btn-primary"
           href="<?php echo U('Exam/index');?>?trainer_id={{d.id}}">考试记录</a>
    </script>
