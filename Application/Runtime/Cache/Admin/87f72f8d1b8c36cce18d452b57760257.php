...
<div class="layui-layout layui-layout-admin">
    ...
    <table class="layui-table" lay-skin="line">
        <colgroup>
            <?php if(is_array($question)): $i = 0; $__LIST__ = $question;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><col><?php endforeach; endif; else: echo "" ;endif; ?>
            <col style="width: 10%">
            <col style="width: 10%">
        </colgroup>
        <thead>
        <tr>
            <?php if(is_array($question)): $i = 0; $__LIST__ = $question;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><th><?php echo ($row["question"]); ?></th><?php endforeach; endif; else: echo "" ;endif; ?>
            <th>养育人</th>
            <th>培训人</th>
            <th>记录时间</th>
        </tr>
        ...
        <tbody>
        <?php if(is_array($answer_data)): $i = 0; $__LIST__ = $answer_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i; if(is_array($row)): $i = 0; $__LIST__ = $row;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                    <?php if(is_array($question)): $i = 0; $__LIST__ = $question;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><td><?php echo ($val[$v['id']]['answer']); ?></td>
                        <?php if($val[$v['id']]){ $info = $val[$v['id']]; } endforeach; endif; else: echo "" ;endif; ?>
                    <td><?php echo ($info['caregiver_name']); ?></td>
                    <td><?php echo ($info['training_people_name']); ?></td>
