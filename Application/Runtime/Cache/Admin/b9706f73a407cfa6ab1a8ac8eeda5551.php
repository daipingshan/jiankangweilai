            ...
            <form class="layui-form layui-form-pane" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="title" value="<?php echo ($info["title"]); ?>" placeholder="请输入知识点标题"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="theme" value="<?php echo ($info["theme"]); ?>" placeholder="请输入知识点主题"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
