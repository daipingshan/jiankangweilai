            ...
            <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
                <select name="course_id">
                    ...
                    <?php if(is_array($course_data)): foreach($course_data as $key=>$val): ?><option value="<?php echo ($key); ?>"
                        <?php if(I('get.course_id') == $key): ?>selected<?php endif; ?>
                        ><?php echo ($val); ?></option><?php endforeach; endif; ?>
                </select>
            </div>
            <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
                <input type="text" name="title" value="<?php echo I('get.title');?>" placeholder="请输入知识点标题"
                       class="layui-input">
            </div>
            <div class="layui-col-xs6 layui-col-sm6 layui-col-md3">
...
<script>
    ...
    <script type="text/html" id="table-edit">
        ...
        <a class="layui-btn layui-btn-xs layui-btn-danger del-data" data-num="{{d.question_num}}"
           data-url="<?php echo U('delete');?>?id={{d.id}}">删除</a>
        <a class="layui-btn layui-btn-xs layui-btn-warm" href="<?php echo U('question');?>?knowledge_id={{d.id}}">问题管理</a>
        <a class="layui-btn layui-btn-xs layui-btn-normal" href="<?php echo U('answer');?>?knowledge_id={{d.id}}">答案统计</a>
    </script>
    <script>
        $(function () {
